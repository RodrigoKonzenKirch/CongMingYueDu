...
class ShowVocabularyListAdapter internal constructor(private val viewModel: ShowVocabularyViewModel): RecyclerView.Adapter<ShowVocabularyListAdapter.ShowVocabularyViewHolder>(){
